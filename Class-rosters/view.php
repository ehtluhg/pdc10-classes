                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?php echo $students['studentsNumber'] ?></th>
                                    <td><?php echo $students['studentName'] ?></td>
                                    <td><?php echo $students['enrolledAt'] ?></td>
                                    <td>
                                        <a onclick="return confirm('Do you want to unenroll?');" href = "delete.php?id=<?php echo $students['id']; ?>" role="button" name="delete">
