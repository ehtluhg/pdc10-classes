    ...
    <div class="m-5 p-3">
        ...
        <div class="m-3 p-2">
            <div class="card mb-4 shadow">
                ...
                <div class="card-body">
                    <a role="button" class="btn btn-secondary m-3" href="add.php">Add Teacher</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a role="button" href="view.php?id=<?php echo $teacher['id']; ?>" name="view">
                                    ...
                                    <td>
                                        <a role="button" href="edit.php?id=<?php echo $teacher['id']; ?>" name="edit">
                                    ...
                                    <td>
                                        <a onclick="return confirm('Do you want to delete this teacher?');" href="delete.php?id=<?php echo $teacher['id']; ?>" role="button" name="delete">
